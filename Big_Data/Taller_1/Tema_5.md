...
**1.** Convierta la lista `[[4,4,2], [3,4,3], [1,3,1]]` en una matriz de 3x3. Réstele una matriz identidad y calcule la suma de todos los elementos. **[0]¿Cuál es el valor de la suma?**
...
**9. RETO FINAL:** Programe la función `mi_operacion(A, B)` que multiplique matrices elemento a elemento con ciclos `for` y sume el total. Matrices: A=[[4, 2], [2, 2]], B=[[1, 1], [3, 1]]. **Valide con evafunciones para obtener su código de éxito.**[7]¿Cuál es el resultado de la función?**.[8]¿Cuál es el código de la validación?
